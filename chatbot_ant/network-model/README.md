...
```
pip install -U pip
pip install numpy scikit-learn pandas jupyter configparser
```
...
```
cp config.sample.ini config.ini # update key-values at your own risk
...
```
python snap_predict.py --model_dir=...
```
