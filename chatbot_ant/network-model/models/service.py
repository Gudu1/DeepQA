...
def create_model_fn(hparams, model_impl):
  ...
  def model_fn(features, targets, mode):
    ...
    if mode == tf.contrib.learn.ModeKeys.EVAL:
      ...
      # Add summaries
      # Note, loss is always logged, and doesn't need to be explicity specified
      # https://www.tensorflow.org/versions/r0.11/tutorials/monitors/index.html#visualizing-log-data-with-tensorboard
